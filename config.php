...
define('BOSSANOVA_JWT_SECRET', '');
// Default Locale
define('DEFAULT_LOCALE', 'en_GB');
// Send a debug notification to an email below in case an query error
define('BOSSANOVA_DATABASE_DEBUG', 'paul.hodel@gmail.com');
...
define('BOSSANOVA_LOGIN_CAPTCHA', 0);
// Login via facebook
define('BOSSANOVA_LOGIN_VIA_FACEBOOK', 0);
// New user via facebook
define('BOSSANOVA_NEWUSER_VIA_FACEBOOK', 0);
// Bossanova native methods (native restful methods)
define('BOSSANOVA_NATIVE_METHODS', 0);
// Autoload view
define('BOSSANOVA_AUTOLOAD_VIEW', 0);
// Base URL
...
define('MS_CONFIG_FROM', 'contact@lemonadejs.net');
define('MS_CONFIG_NAME', 'Contact');
